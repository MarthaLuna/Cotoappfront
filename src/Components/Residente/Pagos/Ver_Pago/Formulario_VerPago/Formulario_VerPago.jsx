...
import './Formulario_VerPago.scss';

export const Formulario_VerPago=()=>
{
    return(
    <section className="Body d-flex align-items-center justify-content-center w-100 mt-4">
        ...
        <Container className="Body-Content d-flex flex-column align-items-center justify-content-start w-100 p-0 m-0">
            ...
            <div
            id="inferior"
            className="d-flex w-100 justify-content-between w-100"
            style={{ paddingBottom: "60px" }}
            >
            <button type="button" className="red-button">
                <span>
                Editar
                <i className="ms-2 bi bi-pencil-fill"></i>
                </span>
            </button>
            <button type="button" className="blue-button">
                <span>
                Eliminar
                <i className="ms-2 bi bi-trash-fill"></i>
                </span>
            </button>
