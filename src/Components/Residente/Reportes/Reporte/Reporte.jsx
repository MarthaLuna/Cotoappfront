  ...
  return (
    <section className="Body d-flex align-items-center justify-content-center w-100 mt-4">
      <div className="Body-Container h-100 d-flex align-items-center justify-content-center w-100">
        <div className="Body-Content d-flex flex-column align-items-center justify-content-start w-100 p-0 m-0">
          <div
            id="Parte-Superior"
            className="mb-4 w-100 w-md-100 d-flex flex-column justify-content-around justify-content-md-between"
          >
            <div id="Titulo-Reporte" style={{ color: "white" }}>
              <h2>Reporte de entradas y salidas del mes actual</h2>
            </div>
