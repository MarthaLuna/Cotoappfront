              ...
              <Card style={{ width: "18rem" }} className="mb-4">
                <Card.Body>
                  ...
                  <Button variant="light">
                    <FiRepeat /> Se repite <AiFillCheckSquare />
                  </Button>
                </Card.Body>
              </Card>
            ...
            <div>
              <Card style={{ width: "18rem" }} className="mb-4">
                <Card.Body>
                  ...
                  <Card.Img
                    variant="top"
                    src="https://yt3.ggpht.com/ytc/AKedOLQjS5obkJNDJtK-RTYhTYrQVFgWzrn3s7RKNe64=s900-c-k-c0x00ffffff-no-rj"
                  />
                </Card.Body>
              </Card>
              <Button className="m-2" variant="primary">
                Limpiar <BsFillBackspaceFill />
              </Button>{" "}
              <Link to="/dashboard/admin/controlGastos">
